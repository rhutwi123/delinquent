...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>SHOPPY-Get everything you need</title>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">SHOPPY-Get everything you need</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">MORE</a>
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li><a href="tabs_and_accordions.html"><i class="fa fa-tasks"></i> Benefits </a></li>
                  <li><a href="content_box.html"><i class="fa fa-list-alt"></i> Rating Analysis</a></li>
                  <li><a href="forms.html"><i class="fa fa-check-square-o"></i> Preferences </a></li>
